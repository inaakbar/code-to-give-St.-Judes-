  ...
  return (
    <>
      ...
      <div className="userFormDiv" id="educationForm">
        <h3>Lifeskills Form (to be done)</h3>
      ...
      <div class="form-floating mb-3 col-md-6 col-lg-4">
          <input type="text" class="form-control" id="medicalAilment" name="medicalAilment" placeholder="name@example.com">
          <label for="medicalAilment">Medical Ailment</label>
        </div>
      <div class="form-floating mb-3 col-md-6 col-lg-4">
